...
AddCard.addEventListener("click",AddNew)
...
function AddNew(){
    ...
    ListTitle.style.textDecoration = 'underline';
    ...
    function myFunc(e) {
        ...
        for (let i = 0; i < activeList.length; i++) {
            if (activeList[i] !== e.target.parentElement.parentElement) {
                ...
                page2Title.innerHTML = `<span style="color:red;">${ListTitle.innerHTML}</span>`
...
newkid.addEventListener('click', () => {
    ...
    pTask.innerHTML = `
        <p class="scratch" id="niki">${text1.value}</p>
